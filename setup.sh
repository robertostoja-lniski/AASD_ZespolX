...
prosodyctl register water_monitoring localhost 1qaz@WSX
prosodyctl register fish_content_monitoring localhost 1qaz@WSX
prosodyctl register weather_monitoring localhost 1qaz@WSX
prosodyctl register crowdiness_monitoring localhost 1qaz@WSX
